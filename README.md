    ...
    <div class="main-container">
        ...
        <header class="bg-gradient-header flex flex-col items-center">
            <div class="header-content">
                <img src="https://placehold.co/192x192/E0F2FE/2563EB?text=Profile" alt="ALAM AL KAHAF Profile Picture" class="profile-picture">
                ...
                <div class="social-icons flex space-x-4 mt-4">
                    ...
                    <button onclick="showInstagramModal()" class="flex items-center justify-center p-0" title="Instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor" class="lucide lucide-instagram">
